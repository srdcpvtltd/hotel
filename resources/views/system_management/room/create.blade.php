...
@endsection
@section('breadcrumb')
<a class="breadcrumb-item" href="{{ route('home') }}">{{ __('Home') }}</a><a class="breadcrumb-item" href="{{ route('room_type.index') }}">{{ __('Room') }}</a><span class="breadcrumb-item active">{{ __('Create') }}</span>
