...
@endsection
@section('breadcrumb')
<a class="breadcrumb-item" href="{{ route('home') }}">{{ __('Home') }}</a><a class="breadcrumb-item" href="{{ route('booking.index') }}">{{ __('Bookings') }}</a><span class="breadcrumb-item active">{{ __('Create') }}</span>
...
<div class="col-md-8 m-auto">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a class="btn btn-secondary" href="{{ route('booking.index') }}"> {{ __('Back') }}</a>
        </div>
        <div>
        </div>
    </div>
