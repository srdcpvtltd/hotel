...
@endsection
@section('breadcrumb')
<a class="breadcrumb-item" href="{{ route('home') }}">{{ __('Home') }}</a><a class="breadcrumb-item" href="{{ route('room_type.index') }}">{{ __('Room Type') }}</a><span class="breadcrumb-item active">{{ __('Create') }}</span>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-secondary" href="{{ route('room_type.index') }}"> {{ __('Back') }}</a>
            </div>
        </div>
    </div>
</div>
