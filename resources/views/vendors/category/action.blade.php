<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        <a href="#" class="action-item" role="button" data-toggle="dropdown"
            ...
            <a href="{{ route('vendor_category.edit', $category->id) }}" class=" dropdown-item"><i
                    class="cil-pencil action-btn"></i>
                {{ __('Edit') }}</a>

        <div class="dropdown-divider"></div>
            <a href="{{ route('vendor_category.index') }}" class="dropdown-item  text-danger"
            ...
            {!! Form::open(['method' => 'DELETE', 'route' => ['vendor_category.destroy', $category->id], 'id' => 'delete-form-' . $category->id]) !!}
            {!! Form::close() !!}
