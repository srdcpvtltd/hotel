<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-Booking')): ?>
            <a href="<?php echo e(route('booking.edit', $booking->id)); ?>" class=" dropdown-item"><i
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-Booking')): ?>
            <a href="<?php echo e(route('booking.index')); ?>" class="dropdown-item  text-danger"
                data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>"
                onclick="delete_record('delete-form-<?php echo e($booking->id); ?>')"><i
...
<?php /**PATH C:\xampp\htdocs\hotel\resources\views/booking/action.blade.php ENDPATH**/ ?>