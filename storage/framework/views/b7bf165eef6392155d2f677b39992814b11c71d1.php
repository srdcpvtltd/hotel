                ...
                <div class="card-header">Criminal Detail</div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 detil-item">
                                <a class="btn btn-danger btn-xs" href="<?php echo e(asset(url('/mark/unsuspicious/'.$booking->id))); ?>">Mark as Not Suspicious</a>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u475147066/domains/saraiodisha.in/public_html/resources/views/guest/detail.blade.php ENDPATH**/ ?>