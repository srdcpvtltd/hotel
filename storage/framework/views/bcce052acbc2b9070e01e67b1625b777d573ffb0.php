<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-Designation')): ?>
            <a href="<?php echo e(route('designation.edit', $designation->id)); ?>" class=" dropdown-item"><i
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-Designation')): ?>
            <a href="<?php echo e(route('designation.index')); ?>" class="dropdown-item  text-danger"
                data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>"
                onclick="delete_record('delete-form-<?php echo e($designation->id); ?>')"><i
...
<?php /**PATH C:\xampp\htdocs\hotel\resources\views/designation/action.blade.php ENDPATH**/ ?>