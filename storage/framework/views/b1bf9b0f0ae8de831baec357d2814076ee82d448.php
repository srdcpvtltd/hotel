...
<?php $__env->startSection('breadcrumb'); ?>
    <a class="breadcrumb-item" href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a><a class="breadcrumb-item"
        href="<?php echo e(route('police_stations.index')); ?>"><?php echo e(__('Plan')); ?></a><span
        class="breadcrumb-item active"><?php echo e(__('Edit')); ?></span>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php echo Form::model($plan, ['method' => 'PATCH', 'route' => ['plans.update', $plan->id]]); ?>
                    ...
                    <select class="form-control" name="role_id" id="role">
                        ...
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($role->name != 'admin' && $role->name != 'user' && $role->name != 'viewer' && $role->name != 'free'): ?>
                                <option value="<?php echo e($role->id); ?>" <?php if($role->id == $plan->role_id): ?> selected <?php endif; ?>><?php echo e($role->name); ?></option>
                            <?php endif; ?>
