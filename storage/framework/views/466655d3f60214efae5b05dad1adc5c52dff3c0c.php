...
<?php $__env->startSection('breadcrumb'); ?>
    <a class="breadcrumb-item" href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a><a class="breadcrumb-item"
        href="<?php echo e(route('police_stations.index')); ?>"><?php echo e(__('Police Station')); ?></a><span
        class="breadcrumb-item active"><?php echo e(__('Edit')); ?></span>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php echo Form::model($policeStation, ['method' => 'PATCH', 'route' => ['police_stations.update', $policeStation->id]]); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <?php echo Form::text('code', null, ['placeholder' => __('Name'),  'class' => 'form-control']); ?>
                ...
                <div class="form-group">
                    ...
                    <select  name="city_id" class="form-select form-select-lg form-control select2" id="city">
                        ...
                        <option value="<?php echo e($city->id); ?>" <?php if($selected_city_id == $city->id): ?> selected <?php endif; ?>><?php echo e($city->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/police_stations/edit.blade.php ENDPATH**/ ?>