<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-module')): ?>
            <a href="<?php echo e(route('modules.edit', $modual->id)); ?>" class=" dropdown-item"><i
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-module')): ?>
            <a href="<?php echo e(route('modules.index')); ?>" class="dropdown-item  text-danger"
                data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>"
                onclick="delete_record('delete-form-<?php echo e($modual->id); ?>')"><i
                    class="cil-trash action-btn"></i><?php echo e(__('Delete')); ?></a>
            <?php echo Form::open(['method' => 'DELETE', 'route' => ['modules.destroy', $modual->id], 'id' => 'delete-form-' . $modual->id]); ?>
...
<?php /**PATH C:\xampp\htdocs\hotel\resources\views/moduals/action.blade.php ENDPATH**/ ?>