...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <img class="c-sidebar-brand-full" src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : '/light_logo.png')); ?>" height="46" class="navbar-brand-img">
        <img class="c-sidebar-brand-minimized" src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : '/small_logo.png')); ?>" height="46" class="navbar-brand-img">
    </div>
    <ul class="c-sidebar-nav ps ps--active-y">
        ...
        <li class="c-sidebar-nav-item">
            <a href="<?php echo e(url('/system_management')); ?>" class="c-sidebar-nav-link">
                <i class="cil-cog c-sidebar-nav-icon"></i><?php echo e(__('System Settings')); ?>
...
</div><?php /**PATH C:\xampp\htdocs\hotel\resources\views/partial/nav-builder.blade.php ENDPATH**/ ?>