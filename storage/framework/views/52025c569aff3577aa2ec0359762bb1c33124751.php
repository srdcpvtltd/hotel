...
<?php echo e(__('Edit Price Rule')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
<a class="breadcrumb-item" href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a><a class="breadcrumb-item" href="<?php echo e(route('cities.index')); ?>"><?php echo e(__('Price Rule')); ?></a><span class="breadcrumb-item active"><?php echo e(__('Edit')); ?></span>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>

<?php echo Form::model($price_rule, ['method' => 'PATCH', 'route' => ['price_rule.update', $price_rule->id]]); ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="room_type_id" id="room_type_id" class="form-control">
                            ...
                            <option value="<?php echo e($roomtype->id); ?>" <?php if( $price_rule->room_type_id == $roomtype->id): ?> selected <?php endif; ?>><?php echo e($roomtype->room_type); ?></option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('extra_adult_price', null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('extra_child_price', null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::time('check_in', null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::time('check_out', null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('overtime_charge', null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('rounded_minutes', null, ['class' => 'form-control']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/system_management/price_rule/edit.blade.php ENDPATH**/ ?>