                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input name="is_visited_before" id="is_visited_before_0" type="radio"
                                                class="custom-control-input" value="1">
                                            <label for="is_visited_before_0" class="custom-control-label">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input name="is_visited_before" id="is_visited_before_1" type="radio"
                        ...
                        <div class="col-md-6 searchPhone" style="display:none">
                            <input name="search" id="searchPhone" required placeholder="search number" type="text"
                                class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="take-img">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <button onClick="take_snapshot()" type="button" class="btn btn-primary take-photo-btn"><i
                                        class="fa fa-camera"></i> Take Snapshot</button>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input name="mobile_number"
                                ...
                                value="<?php echo e($booking->phone_number); ?>" />
                        </div>
                        <div class="col">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input name="arrived_from" required placeholder="Arrived From" type="text"
                                class="form-control">
                        </div>
                        <div class="col">
                    ...
                    <div class="present-address">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input name="house_number" required placeholder="Plot/House Number/At" type="text"
                                    class="form-control">
                            </div>
                            <div class="col">
                                <label>&nbsp;</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col otherHide">
                                <div>
                                    <select required name="state" class="form-select form-select-lg form-control"
                                        id="state">
                        ...
                        <div class="form-row otherDisplay" style="display:none">
                            ...
                            <div class="col">
                                <div>
                                    <input name="other_city" required placeholder="Other City" type="text"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-4 otherHide">
                                <div>
                                    <select required name="city" class="form-select form-select-lg form-control"
                                        id="city">
                            ...
                            <div class="col-4">
                                <input name="present_town" required placeholder="Town" type="text"
                                    class="form-control">
                            </div>
                            <div class="col-4">
                    ...
                    <div class="permanent-address">
                        <div class="form-row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="same_a_present" id="same_a_present" type="checkbox"
                                        class="custom-control-input">
                                    <label for="same_a_present" class="custom-control-label">Same As Present</label>
                                </div>
                            </div>
                            <div class="col">
                                <input name="p_house_number" required placeholder="Plot/House Number/At" type="text"
                                    class="form-control">
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col p_otherHide">
                                <div>
                                    <select required name="p_state" class="form-select form-select-lg form-control"
                                        id="p-state">
                                        <option value="">Select State</option>
                                    </select>
                                </div>
                        ...
                        <div class="form-row p_otherDisplay" style="display:none">
                            <div class="col">
                                <input name="p_other_country" required placeholder="Other Country" type="text"
                                    class="form-control">
                            </div>
                            <div class="col">
                                <div>
                            ...
                            <div class="col">
                                <div>
                                    <input name="p_other_city" required placeholder="Other City" type="text"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-4 p_otherHide">
                                <div>
                                    <select required name="p_city" class="form-select form-select-lg form-control"
                                        id="p-city">
                                        <option value="">Select City</option>
                                    </select>
                                </div>
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input name="local_contact_name" placeholder="Contact Name" type="text"
                                class="form-control">
                        </div>
                        <div class="col">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" required placeholder="Id Number"
                                name="id_number">
                        </div>
                        <!-- <div class="col">
                    ...
                    <div class="form-row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="accompany_person" required id="accompany_person_0" type="radio"
                                            class="custom-control-input is_accompany" value="1">
                                        <label for="accompany_person_0" class="custom-control-label">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="accompany_person" required id="accompany_person_1" type="radio"
                                            class="custom-control-input is_accompany" value="0">
                        ...
                        <div class="col-md-4 accompany-hide">
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input value="" name="accompany_adult" placeholder="Adult" type="number"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 accompany-hide">
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input value="" name="accompany_children" placeholder="Children"
                                        type="number" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2 accompany-hide">
                            <button id="accompany-add" type="button" style="margin-top: 3px;"
    ...
    <script type="text/javascript">
                ...
                success: function(res) {
                    ...
                    $.each(res, function(key, value) {
                        if (sel_city == value.id)
                            $('#' + is_parent + 'city').append('<option value="' + value.id +
                                '" selected="">' + value.name + '</option>');
                        else
                            $('#' + is_parent + 'city').append('<option value="' + value.id + '">' +
                                value.name + '</option>');
                    ...
                    if (!jQuery.isEmptyObject(gustDetail)) {
                        $.each(gustDetail, function(key, value) {
                            if (key == 'guest_image') {
                                ...
                                $('#p_country option[value="' + value + '"]').prop('selected',
                                    false);
                            } else {
                                if (key != 'id_number' && key != 'arrival_date' && key !=
                                    'arrival_time' && key != 'room_booked' && key !=
                                    'accompany_person')
                                    $('input[name="' + key + '"]').val('');
                            }
                        });
                        ...
                        if (!jQuery.isEmptyObject(res)) {
                            ...
                            $.each(res, function(key, value) {
                                if (key == 'guest_image') {
                                    ...
                                    $('#country option[value="' + value + '"]').prop(
                                        'selected', true);
                                } else if (key == 'city_id') {
                                    $('#city option[value="' + value + '"]').prop(
                                        'selected', true);
                                    ...
                                    $('#p-city option[value="' + value + '"]').prop(
                                        'selected', true);
                                    ...
                                    $('#nationality option[value="' + value + '"]')
                                        .prop('selected', true);
                                } else if (key == 'transport') {
                                    $('#transport option[value="' + value + '"]').prop(
                                        'selected', true);
                                } else {
                                    if (key != 'id_number' && key != 'arrival_date' &&
                                        key != 'arrival_time' && key != 'room_booked' &&
                                        key != 'accompany_person')
                            ...
                            if (!jQuery.isEmptyObject(gustDetail)) {
                                $.each(gustDetail, function(key, value) {
                                    ...
                                    if (key == 'guest_image') {
                                        ...
                                        $('#p_country option[value="' + value + '"]')
                                            .prop('selected', false);
                                    } else {
                                        if (key != 'id_number' && key !=
                                            'arrival_date' && key != 'arrival_time' &&
                                            key != 'room_booked' && key !=
                                            'accompany_person')
                                            $('input[name="' + key + '"]').val('');
                                    }
        ...
        $("#accompany-add").click(function() {
            ...
            for (let i = 0; i < total_people; i++) {
                $('.accompany-room-wrapper').append('<div class="form-row accompany-item"><div class="col-md-1">' +
                    (i + 1) +
                    '</div><div class="col"><input type="text" required="" class="form-control" placeholder="Guest Name" name="accompany[' +
                    i + '][guest_name]"></div><div class="col"><select name="accompany[' + i +
                    '][gender]" required="required" class="custom-select"><option value="" selected="">Select Gender</option><option value="male">Male</option><option value="female">Female</option><option value="other">Other</option></select></div><div class="col"><input type="number" required="" class="form-control" placeholder="Age" name="accompany[' +
                    i + '][age]"></div><div class="col"><select name="accompany[' + i +
                    '][relation]" required="required" class="custom-select"><option value="" selected="">Select Relation</option><option value="friend">Friend</option><option value="family">Family</option><option value="other">Other</option></select></div></div>'
                );
            }
        })
    </script>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/booking/register.blade.php ENDPATH**/ ?>