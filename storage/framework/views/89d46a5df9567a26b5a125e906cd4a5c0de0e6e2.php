<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        <a href="#" class="action-item" role="button" data-toggle="dropdown"
            ...
            <a href="<?php echo e(route('expenses_category.edit', $category->id)); ?>" class=" dropdown-item"><i
                    class="cil-pencil action-btn"></i>
                <?php echo e(__('Edit')); ?></a>

        <div class="dropdown-divider"></div>
            <a href="<?php echo e(route('expenses_category.index')); ?>" class="dropdown-item  text-danger"
                data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>"
                onclick="delete_record('delete-form-<?php echo e($category->id); ?>')"><i
                    class="cil-trash action-btn"></i><?php echo e(__('Delete')); ?></a>
            <?php echo Form::open(['method' => 'DELETE', 'route' => ['expenses_category.destroy', $category->id], 'id' => 'delete-form-' . $category->id]); ?>
...
<?php /**PATH C:\xampp\htdocs\hotel\resources\views/expenses/category/action.blade.php ENDPATH**/ ?>