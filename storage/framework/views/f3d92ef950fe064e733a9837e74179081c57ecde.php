...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <span class="breadcrumb-item active"><?php echo e(__('Housekeeping')); ?></span>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('title'); ?>
    <?php echo e(__(' Housekeeping')); ?>
        ...
        <div class="fade-in guest-register">
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i>
                    <h4><?php echo e(__('Housekeeping')); ?></h4>
                </div>
                <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/housekeeping/index.blade.php ENDPATH**/ ?>