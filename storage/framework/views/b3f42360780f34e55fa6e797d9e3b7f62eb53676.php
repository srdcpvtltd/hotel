...
<?php $__env->startSection('content'); ?>
    <?php echo Form::model($food, ['method' => 'PATCH', 'route' => ['food.update', $food->id]]); ?>

    <div class="col-md-12 m-auto">
        <div class="card">
            <div class="card-header"><?php echo e(__('Edit Food Item')); ?> </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <select name="category_id" id="category" class="form-control">
                                ...
                                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($categoryy->id); ?>"
                                        <?php echo e($categoryy->id == $food->category_id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/food/food/edit.blade.php ENDPATH**/ ?>