                    ...
                    <div class="form-row" style="margin-bottom: 15px;">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <option value="indian"  <?php if(isset($inputs) && isset($inputs['nationality']) && $inputs['nationality'] == 'female'): ?> selected <?php endif; ?>>Indian</option>
                                <option value="others"   <?php if(isset($inputs) && isset($inputs['nationality']) && $inputs['nationality'] == 'other'): ?> selected <?php endif; ?>>Others</option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="col"><?php echo e($row->nationality); ?></td>
                                ...
                                <td scope="col"><?php echo e($row->present_pin); ?></td>
                                ...
                                <td scope="col"><a class="btn btn-primary btn-xs" href="<?php echo e(asset(url('/guest/detail/'.$row->id))); ?>">View</a></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<script>
    ...
    function getFilter(){
        $('#reportSearch').attr('action',"<?php echo e(asset(url('guest/report'))); ?>");
        $('#reportSearch').submit();
    }
    function getExport(){
        $('#reportSearch').attr('action',"<?php echo e(asset(url('guest/report/export'))); ?>");
        $('#reportSearch').submit();
    }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u475147066/domains/saraiodisha.in/public_html/resources/views/guest/report/simpleReport.blade.php ENDPATH**/ ?>