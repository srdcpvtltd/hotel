<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-order')): ?>
            <a href="<?php echo e(route('order.edit', $order->id)); ?>" class=" dropdown-item"><i
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-order')): ?>
            <a href="<?php echo e(route('order.index')); ?>" class="dropdown-item  text-danger"
                data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>"
                onclick="delete_record('delete-form-<?php echo e($order->id); ?>')"><i
...
<?php /**PATH C:\xampp\htdocs\hotel\resources\views/Order/action.blade.php ENDPATH**/ ?>