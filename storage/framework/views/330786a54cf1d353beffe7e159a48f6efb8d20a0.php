...
<?php echo e(__('Create Expenses Category')); ?>
...
<?php echo Form::open(['route' => 'expenses_category.store', 'method' => 'POST']); ?>

<div class="col-md-4 m-auto">
    <div class="card">
        <div class="card-header"><?php echo e(__('Create New Expenses Category')); ?> </div>
        <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/expenses/category/create.blade.php ENDPATH**/ ?>