<div class="btn-group">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-System Management')): ?>
            <a href="<?php echo e(route('vendor_category.edit', $category->id)); ?>" class=" dropdown-item"><i
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-System Management')): ?>
            <a href="<?php echo e(route('vendor_category.index')); ?>" class="dropdown-item  text-danger"
            ...
            <?php echo Form::open(['method' => 'DELETE', 'route' => ['vendor_category.destroy', $category->id], 'id' => 'delete-form-' . $category->id]); ?>
...
<?php /**PATH C:\xampp\htdocs\hotel\resources\views/vendors/category/action.blade.php ENDPATH**/ ?>