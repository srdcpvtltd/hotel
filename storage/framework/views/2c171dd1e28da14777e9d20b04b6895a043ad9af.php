...
<?php $__env->startSection('content'); ?>
    <?php echo Form::model($order, ['method' => 'PATCH', 'route' => ['order.update', $order->id]]); ?>

    <div class="col-md-12 m-auto">
        <div class="card">
            <div class="card-header"><?php echo e(__('Edit Order')); ?> </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-lg form-control select2" name="room_id" id="room_id">
                                ...
                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($room->id); ?>" <?php echo e(($order->room_id == $room->id) ? 'selected':''); ?>><?php echo e($room->name); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-lg form-control select2" name="food_category_id"
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" <?php echo e(($order->food_category_id == $category->id) ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-lg form-control select2" name="food_id" id="food_id">
                                ...
                                <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($food->id); ?>" <?php echo e(($order->food_id == $food->id) ? 'selected' : ''); ?>><?php echo e($food->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo Form::text('price', null, ['placeholder' => __('Price'), 'class' => 'form-control', 'id' => 'price', 'readonly']); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-lg form-control select2" name="status" id="status">
                                <option value="">Select</option>
                                <option value="0" <?php echo e(($order->status == 0) ? 'selected':''); ?>>Inprogress</option>
                                <option value="1" <?php echo e(($order->status == 1) ? 'selected':''); ?>>Completed</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\resources\views/order/edit.blade.php ENDPATH**/ ?>